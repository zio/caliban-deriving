...
const siteConfig = {
  title: 'Caliban Deriving',
  tagline: 'Full-featured, robust deriving for Caliban.',
  url: 'https://zio.github.io',
  baseUrl: '/caliban-deriving/',
  ...
  headerLinks: [
    ...
    {href: '/caliban-deriving/api/index.html', label: 'API'},
  ...
  */
  ...
  customDocsPath: 'caliban-deriving-docs/target/mdoc',
